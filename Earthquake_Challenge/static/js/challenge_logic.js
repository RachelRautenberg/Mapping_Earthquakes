...
// Del 3 create a third layer that will be the background of our map.
...
// Del 1.1 & Del 2.1 Add a 2nd layer group for the tectonic plate data, Add a 3rd layer group for the major earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEarthquakes = new L.LayerGroup();

// Del 1.2 and 2.2 Add a reference to the tectonic plates group to the overlays object, Add a reference to the major earthquake group to the overlays object.
let overlays = {
